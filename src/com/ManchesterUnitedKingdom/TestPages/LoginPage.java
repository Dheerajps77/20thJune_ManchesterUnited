...
public class LoginPage {
		...
		public void ChangePassword() throws InterruptedException
		{
			...
			_CurrentPassword.sendKeys("India@321");
			_NewPassword.sendKeys("India@3214");
			_RetypePassword.sendKeys("India@3214");
			Thread.sleep(2000);
		...
		public void ForgetPassword()throws InterruptedException
		{
			...
			YopM_EnterYOurEMailID.sendKeys("testloginmanchester");
			Thread.sleep(2000);
			//YopM_PasswordReset_Link.click();
			Yop_submit.click();
